            ...
            <Card className="mx-2">
                ...
                <CardContent>
                    <p className="text-muted-foreground">
                        This quiz contains insightful questions specific to your industry and skills for your practice. Take your time and choose the best answer for each question.
                    </p>
                </CardContent>
                <CardFooter>
